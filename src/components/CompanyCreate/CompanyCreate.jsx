    ...
    <Tabs defaultActiveKey='1'>
      ...
      <TabPane tab='Mobile ID' key='2'>
        <Fragment>
          ...
          <ol>
            <li>
              <Text>Войти в сервис по логину (email) и паролю. Убедитесь, что номер телефона в Вашей учетной записи &nbsp;
                <strong>совпадает</strong> с номером на sim-карте с ЭЦП. При необходимости, предварительно запросите в службе поддержки
              процедуру замены номера.
              </Text>
            </li>

            <li>
              <Text>Кликнуть по кнопке <strong>Подключить ЭЦП</strong> - выбрать вкладку <strong>Mobile ID</strong> – нажать <strong>Подключить</strong></Text>
            </li>

            <li>
              <Text>Проверьте что Вы разрешили открытие выплывающих окон в браузере. В появившемся окне сервера
                авторизации укажите в международном формате номер телефона sim-карты с ЭЦП, дождитесь поступления на
                Ваш телефон запроса на ввод <strong>PIN 1</strong> для для работы с ЭЦП.
              </Text>
            </li>

            <li>
              <Text>Введите ранее полученный Вами код из 4 цифр (PIN 1). Если все выполнено правильно, и аутентификация
                пройдена успешно, то сервис Вас вернет в рабочее пространство Вашей учетной записи.
              </Text>
            </li>

            <li><Text>Кликнуть <strong>повторно</strong> по по кнопке <strong>Подключить ЭЦП</strong> - выбрать вкладку <strong>Mobile ID</strong> – нажать <strong>Подключить.</strong></Text></li>

            <li>
              <Text>
                Поскольку аутентификация уже пройдена, сервис отобразит окно запроса на выработку ЭЦП – введите
                PIN 2 для работы с ЭЦП. Если ЭЦП в момент подключения верная, не является отозванной и нет иных препятствий
                для ее привязки к Вашей учетной записи, в этот момент Ваша учетная запись (email) будет проассоциирована с
                указанной ЭЦП sim-карте.
              </Text>
            </li>

            <li>
              <Text>В дальнейшем Вы можете осуществлять входа в сервис сразу по Mobile ID, при этом контур Ваших документов будет прежним.</Text>
            </li>
          </ol>
          <Button
            type='primary'
